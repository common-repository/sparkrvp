...
namespace Sparkrvp\MathPHP\Statistics;

use Sparkrvp\MathPHP\Exception;
use Sparkrvp\MathPHP\Functions\Map;
use Sparkrvp\MathPHP\LinearAlgebra\Eigenvalue;
use Sparkrvp\MathPHP\LinearAlgebra\Eigenvector;
use Sparkrvp\MathPHP\LinearAlgebra\NumericMatrix;
use Sparkrvp\MathPHP\LinearAlgebra\MatrixFactory;
use Sparkrvp\MathPHP\Probability\Distribution\Continuous\ChiSquared;
use Sparkrvp\MathPHP\Probability\Distribution\Continuous\StandardNormal;
use Sparkrvp\MathPHP\Trigonometry;
/**
