...
namespace Sparkrvp\MathPHP\Statistics\Regression\Methods;

use Sparkrvp\MathPHP\Exception\BadDataException;
use Sparkrvp\MathPHP\Exception\BadParameterException;
use Sparkrvp\MathPHP\Exception\IncorrectTypeException;
use Sparkrvp\MathPHP\LinearAlgebra\MatrixFactory;
use Sparkrvp\MathPHP\Statistics\RandomVariable;
use Sparkrvp\MathPHP\Functions\Map\Single;
use Sparkrvp\MathPHP\Functions\Map\Multi;
use Sparkrvp\MathPHP\Probability\Distribution\Continuous\F;
use Sparkrvp\MathPHP\Probability\Distribution\Continuous\StudentT;
